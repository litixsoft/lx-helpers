...
//
//        for (field in item) {
//            if (item.hasOwnProperty(field) && ((item.$notToDatabase && item.$notToDatabase.indexOf(field) === -1) || true) && field[0] !== '$') {
//                if (typeof item[field] === 'function' && item[field]() && item[field].isObservableArray) {
//                    clone[field] = [];
//                    ko.utils.arrayForEach(item[field](), function (item) {
//                        // recursion for ko models in observable array
//                        clone[field].push(toJSEx(item));
//                    });
//                } else if (typeof item[field] === 'object') {
//                    clone[field] = toJSEx(item[field]);
//                } else {
